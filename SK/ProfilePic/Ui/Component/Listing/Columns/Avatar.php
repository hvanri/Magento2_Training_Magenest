    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $picture_url = !empty($customer["sk_profile_pic"]) ? $this->urlBuilder->getUrl(
                    'customer/index/viewfile/image/'.base64_encode($customer["sk_profile_pic"])) : $this->viewFileUrl->getUrl('SK_ProfilePric::images/no-profile-photo.jpg');
